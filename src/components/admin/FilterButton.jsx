...
function FilterButton() {
  return (
    <button className="group flex border border-[#D1D1D1] py-2 px-6 rounded-md hover:shadow-2xl hover:border-[#2E99B0] transition-shadow duration-200 items-center bg-white">
